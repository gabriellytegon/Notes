...
export function NewNoteCard({ onNoteCreated }: NewNoteCardProps) {
  ...
  return (
    <Dialog.Root>
      <Dialog.Trigger className="rounded-md flex flex-col text-left bg-slate-700 p-5 gap-3 focus-visible:ring-2 outline-none focus-visible:ring-lime-400 hover:ring-2 hover:ring-slate-600">
